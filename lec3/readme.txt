...
elements properly later. Morever, the practical session will also involve
interaction during the session - where I spend some time in solving or giving
solutions to everyone in the class. 
...
//What do you think the values of a,b,c,d are? 6, 7, 6, 6
--------------------
int x,y,z,w;
...
//What do you think the values of x,y,z & w are? 10, 11, 18, 8 
---------------------
...
Example :$./program 5 
	 ...
	 $./program all
	 Please provide a non-zero integer as program!
	 $./argument 0
...
In the main code :
	...
	timeEnd = GetTime();
	printf("The elapsed time is %d ms", (timeEnd - timeStart)/1000);
-------------------------
